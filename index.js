...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animals) {
    const displaNames = [];
    animals.forEach(a => displaNames.push(`name: ${a.animal_name}, scientific: ${a.scientific_name}`))
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerAnimals = array.map(function(item){
      return item.animal_name.toLowerCase();
    })
    return lowerAnimals;
  }
  
  console.log('Task 1.2:',lowerCaseNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const animalFilter = array.filter(function(item){
      return item.population < 5;
    })
    return animalFilter;
  }
  console.log('Task 1.3:',lowPopulationAnimals(zooAnimals))
  ...
  */
  ...
  function USApop(array){
    const totalAnimals = array.reduce(function(accumulator, item){
      
      return accumulator + item.population;
    },0)
    return totalAnimals;
  }
  console.log("Task 1.4:",USApop(zooAnimals));
...
function greeting(firstname, secondname){
   return `Hello ${firstname} ${secondname}, nice to meet you!`;
  }
